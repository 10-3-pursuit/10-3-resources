...
1. [FETCH & POPULATE DOM WITH API INFO - FOR FRONT END PORTFOLIO](fetch-and-populate-dom.md) - use the fetch command to get information from a third party API and return that information to your HTML.
